...
student = dict()
student.update({'first_name': 'Fatima', 'last_name': 'Ado','gender': 'female','age': 30,'marital_status': 'Married','skills':['MySQL','PowerBI','Python'], 'country':'Nigeria','city': 'Kano','address': 'Zoo Road'})
